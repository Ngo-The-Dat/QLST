...
BEGIN
    SET NOCOUNT ON;
    SET TRANSACTION ISOLATION LEVEL SERIALIZABLE; -- Chống đọc bẩn, đọc không lặp lại, mất cập nhật
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM PHIEUGIAMGIA WITH (UPDLOCK, HOLDLOCK) -- Thực tế không ai tạo mã như vậy
