...
BEGIN
	UPDATE DDH
	SET DDH.SOLUONGDANHAN =
		CASE WHEN DDH.SOLUONGDANHAN + I.SLNHANTHUCTE > DDH.SOLUONGDAT
			THEN DDH.SOLUONGDAT
			ELSE DDH.SOLUONGDANHAN + I.SLNHANTHUCTE
		END
	FROM DONDATHANG DDH
...
('KH01', 2024, 12000000),  -- Bạc (>=10M, <30M)
('KH02', 2024, 60000000),  -- Bạch kim (>=50M)
('KH04', 2024, 8000000),   -- Đồng (<10M)
('KH05', 2024, 2000000),   -- Đồng
('KH06', 2024, 35000000),  -- Vàng (>=30M, <50M)
('KH08', 2024, 15000000),  -- Bạc
('KH09', 2024, 500000),    -- Đồng
('KH10', 2024, 32000000),  -- Vàng
('KH12', 2024, 90000000),  -- Bạch kim
...
('SP03', 'KM03', 500, 0.05), ('SP04', 'KM03', 400, 0.07),
...
('SP35', 'KM02', 200, 0.05), ('SP36', 'KM02', 50, 0.07),
