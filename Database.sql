...
(
	MAKH VARCHAR(10) PRIMARY KEY,
	NGAYDANGKY DATE, -- Để check cấp độ thẻ
	NGAYSINH DATE, -- Để check phiếu giảm giá
	MANV VARCHAR(10),
	MACAPDO VARCHAR(10)
...
(
	...
	-- trang thai de boolean được không
...
(
	...
	CHUNGLOAI NVARCHAR(50) UNIQUE, -- TEN DANH MỤC
	MANV VARCHAR(10)
...
('PG00000001', 0.10, N'Chưa dùng', 'KH01'),
('PG00000002', 0.20, N'Đã dùng', 'KH02');
GO
